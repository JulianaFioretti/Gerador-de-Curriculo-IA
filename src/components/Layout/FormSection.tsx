  ...
  return (
    <div className="flex flex-col p-8">
      <h1 className="text-2xl font-bold mb-6">Monte seu curriculo </h1>
			...
			<p>
				Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis praesentium tempora voluptates nobis exercitationem, harum consectetur earum voluptatum i
				Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eius nostrum excepturi accusamus autem mollitia fugiat vitae hic rerum alias numquam magnam suscipit doloribus earum, sed delectus assumenda repellendus? Facilis, odio.mpedit perferendis architecto cupiditate repudiandae assumenda, dolores veniam unde vitae doloremque reprehenderit.
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam incidunt excepturi quod cupiditate odio perferendis non esse eligendi eos! Ex distinctio enim cumque, laborum voluptas exercitationem modi delectus ab sunt!
